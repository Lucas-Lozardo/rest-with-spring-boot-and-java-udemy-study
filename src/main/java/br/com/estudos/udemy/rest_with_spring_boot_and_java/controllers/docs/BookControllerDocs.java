package br.com.estudos.udemy.rest_with_spring_boot_and_java.controllers.docs;
...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Update a Book", description = "Update a Specific Book by your ID", tags = {"Book"}, responses = {
            @ApiResponse(description = "Success", responseCode = "200",
                    content = @Content(schema = @Schema(implementation = BookDTO.class))
            ),
            @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
    ...
    @Operation(summary = "Delete a Book", description = "Delete a Specific Book by your ID", tags = {"Book"}, responses = {
            @ApiResponse(description = "Success", responseCode = "200",
                    content = @Content(schema = @Schema(implementation = BookDTO.class))
            ),
            @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
